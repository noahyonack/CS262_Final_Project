...
Before you begin reading the README, please note that extensive documentation of the code itself can be found in documentation/pydoc. There you will find autogenerated HTML files corresponding to our code and dependencies. Note that links to all of the dependencies used by our dependencies are also generated but the links are dead. Also note that pydoc uses absolute links so if you want to create your own documentation, just clone the repo and re-run pydoc -w NameOfFile All of these are standard python libraries with documentation online. To view these files, simply open them in your web browser of choice.
